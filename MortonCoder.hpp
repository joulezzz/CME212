...
inline uint32_t spread_bits(uint32_t x) {
  // HW4: YOUR CODE HERE
  x = (x | x << 16) & 0b00000011000000000000001111111111;
  // x 				              0b0000000000000000000000ABCDEFGHIJ
  // mask			              0b00000011000000000000000011111111
  // x << 16	 		          0b000000ABCDEFGHIJ0000000000000000
  // (x | x << 16)	        0b000000ABCDEFGHIJ000000ABCDEFGHIJ			
  // (x | x << 16) & mask	  0b000000AB0000000000000000CDEFGHIJ 
  
  x = (x | x << 8) & 0b00000011000000001111000000001111;
  // x 				              0b000000AB0000000000000000CDEFGHIJ 
  // mask			              0b00000011000000001111000000001111
  // x << 8 			          0b0000000000000000CDEFGHIJ00000000
  // (x | x << 8 )		      0b000000AB00000000CDEFGHIJCDEFGHIJ
  // (x | x << 8 ) & mask	  0b000000AB00000000CDEF00000000GHIJ

  x = (x | x << 4) & 0b00000011000011000011000011000011;
  // x 				              0b000000AB00000000CDEF00000000GHIJ	
  // mask			              0b00000011000011000011000011000011
  // x << 4 			          0b00AB00000000CDEF00000000GHIJ0000	
  // (x | x << 4 )		      0b00AB00AB0000CDEFCDEF0000GHIJGHIJ
  // (x | x << 4 ) & mask	  0b000000AB0000CD0000EF0000GH0000IJ

  x = (x | x << 2) & 0b00001001001001001001001001001001;
  // x 				              0b000000AB0000CD0000EF0000GH0000IJ		 
  // mask			              0b00001001001001001001001001001001
  // x << 2 			          0b0000AB0000CD0000EF0000GH0000IJ00	
  // (x | x << 2 )		      0b0000ABAB00CDCD00EFEF00GHGH00IJIJ
  // (x | x << 2 ) & mask 	0b0000A00B00C00D00E00F00G00H00I00J
...
inline uint32_t compact_bits(uint32_t x) {
  ...
  // x 				              0b0000A00B00C00D00E00F00G00H00I00J		 
  // mask			              0b00000011000011000011000011000011
  // x >> 2 			          0b000000A00B00C00D00E00F00G00H00I0	
  // (x | x >> 2 )		      0b0000A0AB0BC0CD0DE0EF0FG0GH0HI0IJ
  // (x | x >> 2 ) & mask 	0b000000AB0000CD0000EF0000GH0000IJ

  x = (x | x >> 4) & 0b00000011000000001111000000001111;
  // x 				              0b000000AB0000CD0000EF0000GH0000IJ		 
  // mask			              0b00000011000000001111000000001111
  // x >> 4 			          0b0000000000AB0000CD0000EF0000GH00
  // (x | x >> 4 )		      0b000000AB00ABCD00CDEF00EFGH00GHIJ
  // (x | x >> 4 ) & mask 	0b000000AB00000000CDEF00000000GHIJ

  x = (x | x >> 8) & 0b00000011000000000000000011111111;
  // x 				              0b000000AB00000000CDEF00000000GHIJ		 
  // mask			              0b00000011000000000000000011111111
  // x >> 8 			          0b00000000000000AB00000000CDEF0000
  // (x | x >> 8 )		      0b000000AB000000ABCDEF0000CDEFGHIJ
  // (x | x >> 8 ) & mask 	0b000000AB0000000000000000CDEFGHIJ

  x = (x | x >> 8) & 0b00000000000000000000001111111111;
  // x 				              0b000000AB0000000000000000CDEFGHIJ		 
  // mask			              0b00000000000000000000001111111111
  // x >> 8 		          	0b0000000000000000000000AB00000000
  // (x | x >> 8 )	       	0b000000AB00000000000000ABCDEFGHIJ
  // (x | x >> 8 ) & mask 	0b0000000000000000000000ABCDEFGHIJ
